...
import eu.fittest.fbk.efsm2ct.log2efsm.common.PropertiesFileRulesetFactory;
...
public class ModelBasedConverter {
	...
	private StateMappingRuleset rules; 
	
	public ModelBasedConverter() { rules = new FlexstoreV3StateMappingRuleset(); } 
	public ModelBasedConverter(File rulesetFile) throws ConverterException { rules = PropertiesFileRulesetFactory.loadFromFile(rulesetFile); } 
