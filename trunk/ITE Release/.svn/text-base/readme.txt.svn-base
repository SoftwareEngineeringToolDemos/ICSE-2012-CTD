...
Requirements:
	...
	- TXL programming language (http://www.txl.ca/)
	- Haskell platform (http://hackage.haskell.org/platform/)
		- Check installation instructions for Haskell-based tools at: eu.fittest.uu/SoftREADME.TXT
	Third party tools:
	...
	Dependencies:
		- haslog 				(check requirements/dependencies/haslog)
		- daikon 				(check requirements/dependencies/daikon)
		- lopi					(check requirements/dependencies/lopi)
		- dclmerge				(check requirements/dependencies/dclmerge)
		- dtracesplit			(check requirements/dependencies/dtracesplit)
