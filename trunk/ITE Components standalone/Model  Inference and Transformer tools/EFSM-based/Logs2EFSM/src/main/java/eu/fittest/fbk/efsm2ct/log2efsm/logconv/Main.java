...
//	private ModelBasedConverter mbConvert = new ModelBasedConverter();
    /**
     * @param String inputfolderpath: path of the folder that contains the xml
     * logs
     * @param String prefix_outputFileName: prefix of the name for the generated
     * log files
     */
    ...
    private static void usage() {
        System.err.println("usage: [-f <filter-file>] <src dir> <output prefix> <target dir>");
